...
(
    ...
    CONSTRAINT usuario_tipo_usuario_fkey FOREIGN KEY (fk_tipo_usuario_id)
    REFERENCES public.tipo_usuario (pk_tipo_usuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
);
...
(
    ...
    CONSTRAINT paciente_tipo_usuario_fkey FOREIGN KEY (fk_tipo_usuario_id)
        REFERENCES public.tipo_usuario (pk_tipo_usuario) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
...
(
    ...
    CONSTRAINT hospital_tipo_usuario_fkey FOREIGN KEY (fk_tipo_usuario_id)
        REFERENCES public.tipo_usuario (pk_tipo_usuario) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT hospital_tipo_servicio_fkey FOREIGN KEY (fk_tipo_servicio_id)
        REFERENCES public.tipo_servicio (pk_tipo_servicio_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);
...
(
    ...
    CONSTRAINT medico_tipo_servicio_fkey FOREIGN KEY (fk_tipo_servicio_id)
        REFERENCES public.tipo_servicio (pk_tipo_servicio_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT medicoo_especialidad_fkey FOREIGN KEY (fk_especialidad_id)
        REFERENCES public.especialidad (pk_especialidad) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);
...
(
    ...
    CONSTRAINT registro_paciente_fkey FOREIGN KEY (fk_paciente_id)
        REFERENCES public.paciente (pk_paciente_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT registro_medico_fkey FOREIGN KEY (fk_medico_id)
        REFERENCES public.medico (pk_medico_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
);
